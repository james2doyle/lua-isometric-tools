...
function love.load()
  ...
  local tileEvents = {
    ...
    draw = function(tile)
      ...
      love.graphics.draw(assets:get(tile.texture), tile.center.x, tile.center.y, nil, nil, nil, TILE_HALF_WIDTH, TILE_HALF_HEIGHT)
      ...
      if DEBUG then
        ...
        love.graphics.circle("line", tile.hitbox.left, tile.hitbox.top, TILE_QUARTER_HEIGHT + (TILE_HITBOX_PADDING * 2))
...
function love.draw()
  ...
  if tileStates.hovered ~= nil then
    ...
    love.graphics.draw(assets:get("overlay"), tileStates.hovered.center.x, tileStates.hovered.center.y, nil, nil, nil, TILE_HALF_WIDTH, TILE_HALF_HEIGHT)
  end

  if tileStates.active ~= nil then
    love.graphics.setColor(1, 1, 1)

    love.graphics.draw(assets:get("overlay"), tileStates.active.center.x, tileStates.active.center.y, nil, nil, nil, TILE_HALF_WIDTH, TILE_HALF_HEIGHT)
  end
